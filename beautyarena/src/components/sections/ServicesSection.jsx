...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Eliminare permanentă a părului cu laser profesional. Rezultate durabile și sigure.',
      duration: '30-60 min',
      price: 'De la 150 lei',
      rating: 4.9,
      reviews: 78,
      features: ['Consultație gratuită', 'Tehnologie laser avansată', 'Îngrijire post-tratament']
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-elegant font-bold text-gray-900 mb-6">
            ...
            <span className="block text-black">Frumusețe și Epilare</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Oferim servicii complete de înfrumusețare, inclusiv epilare definitivă cu laser,
            realizate de specialiști certificați cu echipamente de ultimă generație.
          </p>
        </div>
          ...
          <div className="relative bg-beauty-pink rounded-2xl p-8 text-white overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl md:text-3xl font-elegant font-bold mb-4">
                Consultație Gratuită pentru Epilare
              </h3>
              <p className="text-pink-100 mb-6 max-w-2xl mx-auto">
                Evaluăm nevoile tale și îți oferim planul perfect de epilare definitivă cu laser.
              </p>
              <button className="bg-[#FFB6A3] text-gray-800 px-4 md:px-8 py-2 md:py-3 rounded-full font-semibold hover:bg-[#FFAB9D] transition-colors duration-300 flex items-center mx-auto text-sm md:text-base">
                ...
                <span className="whitespace-nowrap">Programează acum</span>
