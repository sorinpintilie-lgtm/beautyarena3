...
const ProductsSection = () => {
  ...
  return (
    <section id="products" className="relative section-padding bg-white overflow-hidden">
      {/* Background Image - Hidden on mobile for better focus */}
      <div className="hidden md:block absolute top-0 right-0 w-1/3 h-1/3 overflow-hidden">
        <img
          src="/images/makeup-artist-makes-makeup-to-a-girl-apply-beige-2025-03-13-10-07-09-utc-min.jpg"
          alt="Machiaj profesional"
          className="w-full h-full object-cover rounded-bl-3xl opacity-15"
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-beauty-pink/10 rounded-full border border-beauty-pink/20 mb-6">
            ...
            <span className="text-sm font-medium text-beauty-pink">Îngrijire Post-Epilare</span>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-elegant font-bold text-gray-900 mb-6">
            Produse pentru
            <span className="block text-black">Îngrijire Post-Epilare</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Gamă completă de produse profesionale pentru îngrijirea pielii după epilarea definitivă.
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-3 md:p-6 mb-6 md:mb-8">
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Caută produse pentru îngrijire..."
                value={searchTerm}
        ...
        {/* Products Grid/List - Mobile focused with larger images */}
        {!loading && !error && (
          <div className={`${viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'space-y-3 md:space-y-6'} gap-3 md:gap-6`}>
            {filteredAndSortedProducts.map((product) => {
              ...
              return (
                ...
                >
                  {/* Product Image - Mobile focused with larger display */}
                  <div className={`${viewMode === 'list' ? 'w-20 h-20 flex-shrink-0' : 'w-full h-40 md:h-48'} relative bg-beauty-pink/10 rounded-lg flex items-center justify-center mb-2 md:mb-4 ${viewMode === 'list' ? 'mb-0 mr-2 md:mr-4' : ''}`}>
                    {productImage ? (
                      <img
                        src={productImage}
                        alt={product.name}
